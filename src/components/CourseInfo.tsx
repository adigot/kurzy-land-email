    ...
    <section id="course-info" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <InfoCard icon={<Clock />} title="Délka" description="Celková délka kurzu je 214 hodin, včetně možnosti až týdenního náhledu a konzultace v MŠ Vyšehrádek zdarma. Náhledy jsou možné po domluvě a po absolvování prvních 3 víkendových bloků v kurzu." />
          <InfoCard icon={<Calendar />} title="Harmonogram" description="Začínáme 10.1.2025 blokem Teorie (10.1. - 12.1.). Dále následují bloky Praktický život (22.2. - 23.2.), Smyslová výchova a hudba (21.3. - 23.3.), Matematika I (5.4. - 6.4.), Matematika II a geometrie (26.4. - 27.4.), Jazyková výchova (9.5. - 11.5.), Kosmická výchova I (30.5. - 1.6.), Výroba Montessori pomůcek (léto 2025 - dle domluvy s účastníky kurzu), Kosmická výchova II (25.10. - 26.10.), Společné sdílení (15.11. - 16.11.). Pátky 10:00 - 18:00, soboty 9:00 - 18:00 a neděle 9:00 - 15:00." />
          ...
          <InfoCard icon={<Users2 />} title="Naši lektoři" description="Naším cílem není jen předat vám informace, ale naučit vás, jak pozorovat a nalézt svůj vlastní autentický styl práce. Kurzem vás tak budou provázet zkušené lektorky působící v MŠ Vyšehrádek - Veronika Stárková, Jana Běhounková a Markéta Kalertová, externí lektorka angličtiny Andrea Matysová a externí lektorka geometrie Karin Korčáková, která působí ZŠ Montessori v Praze 12." />
        </div>
      </div>
    </section>
  );
